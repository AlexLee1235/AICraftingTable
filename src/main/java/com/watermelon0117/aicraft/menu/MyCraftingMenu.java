...
public class MyCraftingMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public MyCraftingMenu(int id, Inventory inventory, FriendlyByteBuf buf){
        this(id, inventory);
    }
    ...
    public boolean stillValid(Player p_39368_) {
        return stillValid(this.access, p_39368_, BlockInit.MY_CRAFTING_TABLE.get());
    }
